...
<head>
  ...
  <title>Dashboard - Zard Market</title>
      ...
      <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
          <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
              <a href="index.html" class="fs-4">Zard Mart</a>
            </div>
        ...
        <div class="sidebar-menu">
          <ul class="menu">
            ...
            <li <?php
                ...
                ?> class="sidebar-item">
              <a href="admin.php?pages=dashboard" class="sidebar-link">
            ...
            <li <?php
                ...
                ?> class="sidebar-item">
              <a href="admin.php?pages=user" class="sidebar-link">
            ...
            <li <?php
                ...
                ?> class="sidebar-item">
              <a href="admin.php?pages=barang" class="sidebar-link">
            ...
            <li <?php
                ...
                ?> class="sidebar-item">
              <a href="admin.php?pages=pelanggan" class="sidebar-link">
            ...
            <li <?php
                ...
                ?> class="sidebar-item">
              <a href="admin.php?pages=transaksi" class="sidebar-link">
    ...
    <div id="main">
      ...
      <!-- <footer>
          <div class="footer clearfix mb-0 text-muted">
            <div class="position-absolute bottom-0 start-5">
              <p>2023 &copy; ZardMarket</p>
            </div>
            <div class="position-absolute bottom-0 end-0 mx-3">
              <p>
                Crafted with
                <span class="text-danger"><i class="bi bi-heart"></i></span> by
                <a href="https://saugi.me">Fajar Ilham</a>
              </p>
            </div>
          </div>
        </footer> -->
