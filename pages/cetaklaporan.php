...
<body style="width:100%" class="d-flex justify-content-center">
   <div class="col-7 d-flex justify-content-center">
             <div class="container my-5">
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <div class="col-12 d-flex justify-content-center text-secondary">
                                <small class="fa fa text-secondary mt-1 accessibility-issue--error" style="font-size:12px">Jln. Dagang
                                    No.39 </small>
                            </div>
                            <div class="col-12 d-flex justify-content-center text-secondary">
                    ...
                    <div class="row py-3">
                        <div class="col-3">
                            <img src="../assets/imagetransaksi/alfamart.png" alt="" style="width:60px;height:40px">
                        </div>
                        <div class="col-3">
                            <img src="../assets/imagetransaksi/indomaret.png" alt="" style="width:60px;height:40px">
                        </div>
                        <div class="col-3">
                            <img src="../assets/imagetransaksi/Gojek.png" alt="" style="width:80px;height:40px">
                        </div>
                        <div class="col-3">
                            <img src="../assets/imagetransaksi/shoppe.png" alt="" style="width:70px;height:40px">
                        </div>
                    </div>
                </div>
